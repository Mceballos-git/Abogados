...
var MovementCategoriesService = /** @class */ (function (_super) {
    __extends(MovementCategoriesService, _super);
    function MovementCategoriesService() {
    ...
    MovementCategoriesService.prototype.getMovCategoriesList = function () {
    ...
    MovementCategoriesService.prototype.getOne = function (id) {
        var url = this.getURL(this.constants.REQUEST_MODULE, this.constants.ENDPOINT_GET_ONE);
        var headers = this.getRequestOptions(true);
        url = url.replace(':id', id);
        return this.http.get(url, headers);
    };
    MovementCategoriesService.prototype.delete = function (id) {
    ...
    MovementCategoriesService.prototype.create = function (formData) {
    ...
    MovementCategoriesService.prototype.updateMovCategories = function (id, data) {
    ...
    MovementCategoriesService.prototype.getFormRequestBody = function (formData) {
        return {
            name: formData.name,
        };
    };
    MovementCategoriesService = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        })
    ], MovementCategoriesService);
    return MovementCategoriesService;
}(request_helper_service_1.RequestHelperService));
exports.MovementCategoriesService = MovementCategoriesService;
//# sourceMappingURL=movement-categories.service.js.map