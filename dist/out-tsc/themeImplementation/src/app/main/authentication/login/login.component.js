...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(_fuseConfigService, _formBuilder, _authService, _dialog, _router) {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.openDialog();
        // Do Login Request
        this._authService.login(this.loginForm.value).subscribe(function (response) {
            _this.handleLoginSuccess(response);
        }, function (response) {
            _this.handleLoginError(response);
        });
        return true;
    };
    /**
