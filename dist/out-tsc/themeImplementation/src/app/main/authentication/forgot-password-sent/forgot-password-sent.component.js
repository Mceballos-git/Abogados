...
var ForgotPasswordSentComponent = /** @class */ (function () {
    function ForgotPasswordSentComponent(_fuseConfigService, _formBuilder, _userSecurityService, _dialog, _router) {
     ...
     * On init
     */
    ForgotPasswordSentComponent.prototype.ngOnInit = function () {
     ...
     * @returns {boolean}
     */
    ForgotPasswordSentComponent.prototype.onSubmit = function () {
        var _this = this;
     ...
     * @returns {any}
     */
    ForgotPasswordSentComponent.prototype.openDialog = function () {
     ...
     * @param response
     */
    ForgotPasswordSentComponent.prototype.handlePostSubmitSuccess = function (response) {
     ...
     * @param response
     */
    ForgotPasswordSentComponent.prototype.handlePostSubmitError = function (response) {
        this.loadingDialogRef.close();
        this.forgotPasswordForm.reset();
        this.forgotPasswordFailed = true;
    };
    var _a;
    ForgotPasswordSentComponent = __decorate([
        core_1.Component({
    ...
    return ForgotPasswordSentComponent;
}());
exports.ForgotPasswordSentComponent = ForgotPasswordSentComponent;
//# sourceMappingURL=forgot-password-sent.component.js.map